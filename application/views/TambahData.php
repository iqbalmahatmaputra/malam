...
<div class="col-6">
	<div class="card">
		...
		<div class="card-titile">
			...
			<form action=<?php echo site_url('mahasiswa/insertData'); ?> method="post">
				<div class="container">
					<div class="form-group">
						<label for="nim">Nim</label>
						<input type="number" class="form-control" placeholder="ex: 1455301035" name="nim" id="nim">
					</div>
					<div class="form-group">
						<label for="nama">Nama</label>
						<input type="text" class="form-control" placeholder="ex: Iqbal Mahatma" name="nama" id="nama">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="ex: Jl. Sekolah" name="alamat" id="alamat">
					</div>
					<div class="form-group">
						<label for="telfon">Telfon</label>
						<input type="number" class="form-control" placeholder="ex: 08121616172" name="telfon" id="telfon">
					</div>
                    <div class="form-group">
