...
<table class="table table-hover">
  ...
  <?php 
		...
		<tr>
			...
			<td><div class="btn-group" role="group" aria-label="Aksi">
      <a class="btn btn-warning btn-lg" href=<?php echo site_url('Mahasiswa/edit/'.$u->nim); ?> role="button">Ubah</a>
      <a class="btn btn-danger btn-lg" href=<?php echo site_url('Mahasiswa/delete/'.$u->nim); ?> role="button">Hapus</a>
</div></td>
		</tr>
		<?php } ?>
  </tbody>
